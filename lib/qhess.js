...
class Board {
    constructor() {
        ...
        for(let i = 0; i < BOARD_SIZE; i++) 
            this.board[0][i].addPiece(new backRow[i](0, i, "BLACK", uuidv4()));
        for(let i = 0; i < BOARD_SIZE; i++) 
            this.board[1][i].addPiece(new Pawn(1, i, "BLACK", uuidv4()));
        // add white pieces
        for(let i = 0; i < BOARD_SIZE; i++) 
            this.board[6][i].addPiece(new Pawn(6, i, "WHITE", uuidv4()));
        for(let i = BOARD_SIZE-1; i >= 0; i--) 
            this.board[7][i].addPiece(new backRow[i](7, i, "WHITE", uuidv4()));
    }
